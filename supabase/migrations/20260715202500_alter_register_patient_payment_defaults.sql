-- Migration: Reorder parameters to keep p_user_id mandatory, make p_reason and p_reversed_payment_id optional, and drop the old overloaded function signature

-- 1. Drop the old function signature to prevent overloading
DROP FUNCTION IF EXISTS public.register_patient_payment(uuid, uuid, text, numeric, text, uuid, uuid);
