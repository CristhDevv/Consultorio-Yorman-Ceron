...
npm run test → Vitest, 22 pruebas pasando en 5 archivos (environment, patients/actions, appointments/actions, appointments/availability, appointments/AppointmentForm), convención de carpeta tests forzada estructuralmente vía include en vitest.config.ts
