    ...
    <div className="min-h-screen flex" style={{ background: "#F7F9FC" }}>
      ...
      >
        <div className="max-w-sm text-center">
          ...
          <h1 className="text-3xl font-extrabold mb-6 tracking-tight">Consultorio Odontológico</h1>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            ...
            <div>
              <p className="text-sm font-bold text-[#1E293B]">Consultorio Odontológico</p>
              <p className="text-[10px] text-[#64748B] uppercase tracking-wider">Gestión Clínica</p>
            </div>
          </div>
